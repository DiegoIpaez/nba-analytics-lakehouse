...
SELECT
    ...
    COUNT(CASE WHEN game_result = 'W' THEN 1 END) AS games_won,
    COUNT(CASE WHEN game_result = 'L' THEN 1 END) AS games_lost,
...
FROM base
GROUP BY team_name, game_id, season_id, game_date, is_home_game, opponent_team_name
